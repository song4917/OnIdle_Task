...
// MFC3.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BOOL CMFC3App::OnIdle(LONG lCount)
{
	// TODO: 여기에 특수화된 코드를 추가 및/또는 기본 클래스를 호출합니다.
	CWinApp::OnIdle(lCount);

	// 프레임에 WM_IDLE 메시지 보내기

	if (m_pMainWnd) m_pMainWnd->SendMessage(WM_ANU_IDLE);
